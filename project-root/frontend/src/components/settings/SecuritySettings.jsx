...
const SecuritySettings = () => {
    ...
    return (
        <div className={styles.settingsSection} style={{ backgroundColor: backgroundColor }}>
            <h2 style={{ color: textColor }}>Impostazioni di sicurezza</h2>
            <div className={styles.settingItem} style={{ backgroundColor: backgroundColor2 }}>
                <label style={{ color: textColor }}>Nuova password</label>
                <input
                    type="password"
            ...
            <div className={styles.settingItem} style={{ backgroundColor: backgroundColor2 }}>
                <label style={{ color: textColor }}>Conferma la Password</label>
                <input
                    type="password"
            ...
            <div className={styles.settingItem} style={{ backgroundColor: backgroundColor2 }}>
                <label style={{ color: textColor }}>Doppio fattore di autenticazione</label>
                <select
                    value={twoFactor}
            ...
            <div className={styles.settingItem} style={{ backgroundColor: backgroundColor2 }}>
                <label style={{ color: textColor }}>Storico Login</label>
            ...
            <div className={styles.settingItem} style={{ backgroundColor: backgroundColor2 }}>
                <label style={{ color: textColor }}>Sessioni attive</label>
